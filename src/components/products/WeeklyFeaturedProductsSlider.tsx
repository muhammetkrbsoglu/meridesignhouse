      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-block bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200/60 rounded-md sm:rounded-lg p-1.5 sm:p-2 shadow-sm"
          >
            <div className="flex items-center justify-center gap-1.5 text-amber-800">
              ...
              >
                <LightBulbIcon className="w-2.5 h-2.5 sm:w-3 sm:h-3 text-amber-500" />
              </motion.div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
                  ...
                  <div className="flex flex-col justify-center p-0 sm:p-0.25 lg:p-0.5 bg-gradient-to-br from-white via-rose-50 to-pink-50 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      {/* Product Name */}
                      <motion.h3
                        className="text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-gray-900 mb-2 sm:mb-3 leading-tight"
