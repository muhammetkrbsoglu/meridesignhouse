                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
                  ...
                  <div className="flex flex-col justify-center p-2 lg:p-6 bg-gradient-to-br from-white via-rose-50 to-pink-50 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      {/* Product Name */}
                      <motion.h3
                        className="text-sm md:text-base lg:text-xl font-bold text-gray-900 mb-0.5 md:mb-1 lg:mb-2 leading-tight"
                      ...
                      {/* Product Description */}
                      <motion.p
                        className="text-gray-600 text-xs mb-0.5 md:mb-1 lg:mb-2 leading-relaxed"
                        initial={{ opacity: 0, x: -20 }}
                        animate={{ opacity: 1, x: 0 }}
                      ...
                      <motion.div
                        className="bg-gradient-to-r from-rose-100 to-pink-100 border-2 border-rose-300 rounded-xl p-2 mb-0.5 md:mb-1 lg:mb-2"
                      ...
                      >
                        ...
                        <Link
                          ...
                          className="flex-1 min-w-[120px] bg-white border-2 border-rose-500 text-rose-600 hover:bg-rose-50 px-1.5 py-1.5 rounded-lg font-semibold text-center transition-all duration-300 relative overflow-hidden group flex items-center justify-center"
                        >
