    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="border-b border-gray-200 pb-4">
          <h1 className="text-2xl font-bold text-gray-900">WhatsApp Mesaj Şablonları</h1>
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900">Yeni Şablon Ekle</h2>
          </div>
          <div className="p-6">
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900">Mevcut Şablonlar</h2>
          </div>
